...
export default function Tasks() {
  ...
  const { showNudge, nudgeMessage, dismissNudge, resetNudge } = useActionNudge();
  ...
  return (
    <div className="space-y-6 sm:space-y-8 max-w-3xl mx-auto">
      ...
      {/* Action nudge banner */}
      <ActionNudgeBanner
        show={showNudge && pendingCount > 0}
        message={nudgeMessage}
        onDismiss={dismissNudge}
        contextLine={`You have ${pendingCount} pending task${pendingCount !== 1 ? "s" : ""}. The app is a tool, not a destination!`}
      />

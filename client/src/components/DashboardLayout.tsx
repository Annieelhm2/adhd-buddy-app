...
import { ListTodo, MessageCircle, LogOut, PanelLeft } from "lucide-react";
...
export default function DashboardLayout({
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 via-background to-teal-50">
